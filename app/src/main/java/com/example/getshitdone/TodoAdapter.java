...
public class TodoAdapter extends RecyclerView.Adapter<TodoAdapter.ViewHolder> {
     ...
     *
     * @param dataSet List<Todo> containing the data to populate views to be used
     * by RecyclerView.
     */
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int position) {
        ...
        viewHolder.getTextView().setText(todoList.get(position).getName());
    }
    ...
    public void updateLocalData(List<Todo> newData) {
        todoList.clear();
